...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/002-138"
        self.subject_id = "002-138"
        self.rbc_m_ratio = 0.56
        ...
        self.manual_seg_filepath = (
            "/mnt/d/xenon-gas-exchange-consortium/data/002-138/mask.nii"
        )
