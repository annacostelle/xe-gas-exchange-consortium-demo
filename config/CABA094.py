...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/CABA094/data/mrd"
        self.subject_id = "CABA094"
        self.rbc_m_ratio = 0.402
        self.patient_frc = "None"
        self.bag_volume = "None"
        self.segmentation_key = constants.SegmentationKey.CNN_VENT.value
        self.manual_seg_filepath = "/mnt/d/xenon-gas-exchange-consortium/data/CABA094/data/mrd/mask_reg_corrected.nii"
