...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/TY-002A/data/mrd"
        self.subject_id = "TY-002A"
        self.rbc_m_ratio = 0.251
        self.patient_frc = "None"
        self.bag_volume = "None"
        self.segmentation_key = constants.SegmentationKey.MANUAL_VENT.value
        self.manual_seg_filepath = "/mnt/d/xenon-gas-exchange-consortium/data/TY-002A/data/mrd/mask_reg_corrected.nii"
