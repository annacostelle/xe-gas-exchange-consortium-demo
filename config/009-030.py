...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/009-030"
        self.subject_id = "009-030"
        self.rbc_m_ratio = 0.127
        ...
        self.manual_seg_filepath = (
            "/mnt/d/xenon-gas-exchange-consortium/data/009-030/mask_reg_corrected.nii"
        )
