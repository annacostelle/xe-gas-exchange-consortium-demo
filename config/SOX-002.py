...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/SOX-002/data/mrd"
        self.subject_id = "SOX-002"
        self.rbc_m_ratio = 0.09
        self.patient_frc = "None"
        self.bag_volume = "None"
        self.segmentation_key = constants.SegmentationKey.MANUAL_VENT.value
        self.manual_seg_filepath = "/mnt/d/xenon-gas-exchange-consortium/data/SOX-002/data/mrd/mask_reg_corrected.nii"
