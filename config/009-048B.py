...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/007-02-008"
        self.subject_id = "007-02-008"
        self.rbc_m_ratio = 0.457
        ...
        self.manual_seg_filepath = (
            "/mnt/d/xenon-gas-exchange-consortium/data/008-033/mask_reg_corrected.nii"
        )
