...
class Config(config_dict.ConfigDict):
    ...
    def __init__(self):
        ...
        self.data_dir = "/mnt/d/xenon-gas-exchange-consortium/data/008-042"
        self.subject_id = "008-042"
        self.rbc_m_ratio = 0.453
        ...
        self.manual_seg_filepath = (
            "/mnt/d/xenon-gas-exchange-consortium/data/008-042/mask_reg_corrected.nii"
        )
...
class OscillationRecon(object):
    def __init__(self):
        """Initialize the reconstruction parameters."""
        self.oscillation_analysis = True
